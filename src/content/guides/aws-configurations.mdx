...
1. [Create an AWS account](https://dub.sh/mly-signup-aws) if you don't have one.
2. [Create an IAM user](https://dub.sh/mly-iam-user) with the following permissions:
